...
const insertTextSpan = () => {
    const textSpan = styleBoxShadow
    const firstIndex = textSpan.slice(1)
    firstIndex.push(textSpan[0])

    allSpansCopy.forEach(span => span.textContent = firstIndex.join(" "))
}
